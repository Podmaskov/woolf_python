...
def load_data(filename="addressbook.pkl"):
    """
    Завантажує AddressBook з файлу за допомогою pickle.
    Якщо файл не знайдений, повертає новий AddressBook.
    """
    try:
...
def main():
    ...
    Завантажує AddressBook з файлу при запуску та зберігає при закритті.
    """
    book = load_data()
